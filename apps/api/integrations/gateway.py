...
def build_mcp(get_plane):
    ...
    server = FastMCP("Sonic AI V3", stateless_http=True, json_response=True,
        ...
        instructions="Read-only operator tools. Status returns timestamped evidence; use the operator HTTP check endpoint to refresh providers. No Shopify mutation capability is exposed.")
